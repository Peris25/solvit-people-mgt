...
export default function LnD() {
  ...
  return (
    <div data-testid="lnd-page" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
      ...
      {tab === 'skills' && (
        <div style={{ backgroundColor: '#fff', border: '1px solid rgba(25,25,25,0.08)', padding: '32px', textAlign: 'center', color: '#525252' }}>
          <p style={{ fontSize: '14px', fontWeight: 700, color: '#191919' }}>Skills Matrix</p>
          <p style={{ fontSize: '12px' }}>Track skill levels (Beginner / Intermediate / Advanced / Expert) per employee. Per-employee matrix available via API.</p>
        </div>
      )}
