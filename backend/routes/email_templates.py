...
DEFAULT_TEMPLATES = [
    ...
    # ─────────────────────────────────────────────────────────────────
    # Reminder Service templates (fired by reminders/engine.py)
    # ─────────────────────────────────────────────────────────────────
    {"key": "reminder.onboard_overdue", "module": "Reminders", "name": "Onboarding Check-In Overdue",
     "subject": "Onboarding check-in overdue — {{employee_name}}",
     "merge_tags": ["employee_name","milestone","days_overdue","platform_link"],
     "body": "<p>The <strong>{{milestone}}-day</strong> onboarding check-in for <strong>{{employee_name}}</strong> is <strong>{{days_overdue}} day(s) overdue</strong>. Please complete it as soon as possible.</p><p><a href=\"{{platform_link}}\">Open the check-in form</a></p>"},
    {"key": "reminder.prob_7day", "module": "Reminders", "name": "Probation Review Due in 7 Days",
     "subject": "Probation review due in 7 days — {{employee_name}}",
     "merge_tags": ["employee_name","probation_end_date","platform_link"],
     "body": "<p>The probation review for <strong>{{employee_name}}</strong> is due on <strong>{{probation_end_date}}</strong> (in 7 days).</p><p><a href=\"{{platform_link}}\">Open the probation review form</a></p>"},
    {"key": "reminder.prob_due", "module": "Reminders", "name": "Probation Review Due Today",
     "subject": "Probation review due TODAY — {{employee_name}}",
     "merge_tags": ["employee_name","probation_end_date","platform_link"],
     "body": "<p>The probation review for <strong>{{employee_name}}</strong> is due <strong>today</strong>. Please record the outcome.</p><p><a href=\"{{platform_link}}\">Record outcome</a></p>"},
    {"key": "reminder.prob_overdue", "module": "Reminders", "name": "Probation Review Overdue",
     "subject": "OVERDUE — Probation review for {{employee_name}} ({{days_overdue}} days)",
     "merge_tags": ["employee_name","probation_end_date","days_overdue","platform_link"],
     "body": "<p>The probation review for <strong>{{employee_name}}</strong> ended on <strong>{{probation_end_date}}</strong> and is now <strong>{{days_overdue}} day(s) overdue</strong>. No outcome has been recorded.</p><p><a href=\"{{platform_link}}\">Resolve now</a></p>"},
    {"key": "reminder.perf_self_overdue", "module": "Reminders", "name": "Self-Review Overdue",
     "subject": "Self-review overdue — please complete",
     "merge_tags": ["employee_name","days_overdue","platform_link"],
     "body": "<p>Hi {{employee_name}},</p><p>Your self-review is <strong>{{days_overdue}} day(s) overdue</strong>. Please submit as soon as possible.</p><p><a href=\"{{platform_link}}\">Open your self-review</a></p>"},
    {"key": "reminder.perf_mgr_overdue", "module": "Reminders", "name": "Manager Review Overdue",
     "subject": "Manager review overdue — {{employee_name}}",
     "merge_tags": ["employee_name","days_overdue","platform_link"],
     "body": "<p>The manager review for <strong>{{employee_name}}</strong> is <strong>{{days_overdue}} day(s) overdue</strong>. Please complete it.</p><p><a href=\"{{platform_link}}\">Open review</a></p>"},
    {"key": "reminder.pip_ending", "module": "Reminders", "name": "PIP Period Ending in 7 Days",
     "subject": "PIP ends in 7 days — {{employee_name}}",
     "merge_tags": ["employee_name","pip_end_date","platform_link"],
     "body": "<p>The Performance Improvement Plan for <strong>{{employee_name}}</strong> ends on <strong>{{pip_end_date}}</strong>. An outcome decision must be recorded by that date.</p><p><a href=\"{{platform_link}}\">Open PIP</a></p>"},
    {"key": "reminder.survey_final_day", "module": "Reminders", "name": "Survey Closes Today",
     "subject": "Final reminder — Alignment Survey closes TODAY",
     "merge_tags": ["employee_name","close_date","platform_link"],
     "body": "<p>Hi {{employee_name}},</p><p>The Alignment Survey closes <strong>today</strong>. Your voice matters — please take 5 minutes to respond.</p><p><a href=\"{{platform_link}}\">Take the survey</a></p>"},
    {"key": "reminder.solver_survey_3day", "module": "Reminders", "name": "Solver Survey Closes in 3 Days",
     "subject": "Solver survey closes in 3 days",
     "merge_tags": ["solver_name","close_date","platform_link"],
     "body": "<p>Hi {{solver_name}},</p><p>The Solver survey closes on <strong>{{close_date}}</strong> (in 3 days). Please share your feedback.</p><p><a href=\"{{platform_link}}\">Open survey</a></p>"},
    {"key": "reminder.leave_year_end", "module": "Reminders", "name": "Leave Year Ending — Unused Balance",
     "subject": "Leave year ending — you have {{remaining_balance}} unused days",
     "merge_tags": ["employee_name","remaining_balance","leave_year_end_date","platform_link"],
     "body": "<p>Hi {{employee_name}},</p><p>The leave year ends on <strong>{{leave_year_end_date}}</strong> and you have <strong>{{remaining_balance}} day(s)</strong> unused. Plan your leave before year end so you don't lose them.</p><p><a href=\"{{platform_link}}\">Submit a leave request</a></p>"},
    {"key": "reminder.leave_approval", "module": "Reminders", "name": "Leave Request Awaiting Your Approval",
     "subject": "Pending leave request — {{employee_name}} ({{days_pending}} days)",
     "merge_tags": ["employee_name","leave_type","days_pending","platform_link"],
     "body": "<p>A leave request from <strong>{{employee_name}}</strong> ({{leave_type}}) has been pending for <strong>{{days_pending}} day(s)</strong>.</p><p><a href=\"{{platform_link}}\">Review and approve</a></p>"},
    {"key": "reminder.leave_return", "module": "Reminders", "name": "Employee Returns from Leave Tomorrow",
     "subject": "{{employee_name}} returns from leave tomorrow",
     "merge_tags": ["employee_name","leave_type"],
     "body": "<p>FYI — <strong>{{employee_name}}</strong> returns from {{leave_type}} leave tomorrow. No action required.</p>"},
    {"key": "reminder.recog_event_14day", "module": "Reminders", "name": "Recognition Event in 14 Days",
     "subject": "Recognition event in 14 days — {{event_name}}",
     "merge_tags": ["event_name","event_date","platform_link"],
     "body": "<p><strong>{{event_name}}</strong> is on <strong>{{event_date}}</strong> (in 14 days) and no preparation tasks have been assigned yet.</p><p><a href=\"{{platform_link}}\">Open event</a></p>"},
    {"key": "reminder.recog_event_3day", "module": "Reminders", "name": "Recognition Event in 3 Days",
     "subject": "Recognition event in 3 days — {{event_name}}",
     "merge_tags": ["event_name","event_date","platform_link"],
     "body": "<p>Final reminder — <strong>{{event_name}}</strong> takes place on <strong>{{event_date}}</strong> (in 3 days). Confirm task completion.</p><p><a href=\"{{platform_link}}\">Open event</a></p>"},
    {"key": "reminder.solver_award_open", "module": "Reminders", "name": "Solver Award Cycle Opening",
     "subject": "{{quarter}} Solver Award cycle is now open",
     "merge_tags": ["quarter","platform_link"],
     "body": "<p>The <strong>{{quarter}}</strong> Solver Award cycle is now open. Review scores and select nominees.</p><p><a href=\"{{platform_link}}\">Open Solver Performance</a></p>"},
    {"key": "reminder.solver_award_deadline", "module": "Reminders", "name": "Solver Award Nominations Due in 7 Days",
     "subject": "{{quarter}} Solver Award nominations due in 7 days",
     "merge_tags": ["quarter","deadline","platform_link"],
     "body": "<p>Reminder — <strong>{{quarter}}</strong> Solver Award nominations are due by <strong>{{deadline}}</strong> (in 7 days).</p><p><a href=\"{{platform_link}}\">Submit nominations</a></p>"},
    {"key": "reminder.stay_interview_due", "module": "Reminders", "name": "Stay Interview Due",
     "subject": "Stay interview due — {{employee_name}} ({{tenure_years}}y milestone)",
     "merge_tags": ["employee_name","tenure_years","platform_link"],
     "body": "<p><strong>{{employee_name}}</strong> has reached their <strong>{{tenure_years}}-year</strong> milestone. Schedule a stay interview.</p><p><a href=\"{{platform_link}}\">Schedule</a></p>"},
    {"key": "reminder.stay_interview_overdue", "module": "Reminders", "name": "Stay Interview Overdue",
     "subject": "Stay interview overdue — {{employee_name}}",
     "merge_tags": ["employee_name","scheduled_date","platform_link"],
     "body": "<p>The stay interview scheduled with <strong>{{employee_name}}</strong> on <strong>{{scheduled_date}}</strong> was not completed. Please reschedule.</p><p><a href=\"{{platform_link}}\">Open</a></p>"},
    {"key": "reminder.exit_task_overdue", "module": "Reminders", "name": "Exit Clearance Task Overdue",
     "subject": "Exit clearance task overdue — {{employee_name}}",
     "merge_tags": ["employee_name","last_working_date","days_overdue","platform_link"],
     "body": "<p>An exit clearance task for <strong>{{employee_name}}</strong> (last working day: {{last_working_date}}) is <strong>{{days_overdue}} day(s) overdue</strong>.</p><p><a href=\"{{platform_link}}\">Open clearance checklist</a></p>"},
    {"key": "reminder.exit_final_week", "module": "Reminders", "name": "Exit Final Week Alert",
     "subject": "Final week — {{employee_name}} departs in 5 days",
     "merge_tags": ["employee_name","last_working_date","pending_tasks","platform_link"],
     "body": "<p><strong>{{employee_name}}</strong>'s last working day is <strong>{{last_working_date}}</strong> (in 5 working days). <strong>{{pending_tasks}}</strong> clearance task(s) still pending.</p><p><a href=\"{{platform_link}}\">Open checklist</a></p>"},
    {"key": "reminder.exit_conf_ack_chase", "module": "Reminders", "name": "Confidentiality Ack Not Signed",
     "subject": "URGENT — confidentiality acknowledgement not signed",
     "merge_tags": ["employee_name","last_working_date","days_remaining","platform_link"],
     "body": "<p>The Post-Employment Confidentiality & Non-Solicitation Acknowledgement for <strong>{{employee_name}}</strong> is still unsigned. Last working day: <strong>{{last_working_date}}</strong> ({{days_remaining}} day(s) remaining).</p><p><a href=\"{{platform_link}}\">Sign now</a></p>"},
    {"key": "reminder.candidate_stale", "module": "Reminders", "name": "Candidate Stale in Pipeline",
     "subject": "Candidate awaiting action — {{candidate_name}}",
     "merge_tags": ["candidate_name","role_applied_for","current_stage","days_in_stage","platform_link"],
     "body": "<p><strong>{{candidate_name}}</strong> (applying for {{role_applied_for}}) has been in stage <strong>{{current_stage}}</strong> for <strong>{{days_in_stage}}</strong> day(s) with no action.</p><p><a href=\"{{platform_link}}\">Open candidate</a></p>"},
    {"key": "reminder.offer_expiring", "module": "Reminders", "name": "Offer Expiring in 2 Days",
     "subject": "Offer expires in 2 days — {{candidate_name}}",
     "merge_tags": ["candidate_name","role_applied_for","offer_expiry_date","platform_link"],
     "body": "<p>The offer to <strong>{{candidate_name}}</strong> for <strong>{{role_applied_for}}</strong> expires on <strong>{{offer_expiry_date}}</strong> and has not yet been accepted or declined.</p><p><a href=\"{{platform_link}}\">Open candidate</a></p>"},
    {"key": "reminder.hrcal_14day", "module": "Reminders", "name": "HR Calendar Event in 14 Days",
     "subject": "HR calendar event in 14 days — {{event_name}}",
     "merge_tags": ["event_name","event_date","platform_link"],
     "body": "<p><strong>{{event_name}}</strong> is scheduled for <strong>{{event_date}}</strong> (in 14 days). No preparation tasks have been assigned yet.</p><p><a href=\"{{platform_link}}\">Open event</a></p>"},
    {"key": "reminder.hrcal_3day", "module": "Reminders", "name": "HR Calendar Event in 3 Days",
     "subject": "HR calendar event in 3 days — {{event_name}}",
     "merge_tags": ["event_name","event_date","platform_link"],
     "body": "<p>Final reminder — <strong>{{event_name}}</strong> is on <strong>{{event_date}}</strong> (in 3 days).</p><p><a href=\"{{platform_link}}\">Open event</a></p>"},
    {"key": "reminder.hrcal_overdue", "module": "Reminders", "name": "HR Calendar Event Overdue",
     "subject": "HR calendar event overdue — {{event_name}}",
     "merge_tags": ["event_name","event_date","platform_link"],
     "body": "<p><strong>{{event_name}}</strong> (scheduled for {{event_date}}) passed without being marked complete. Close it or reschedule.</p><p><a href=\"{{platform_link}}\">Open event</a></p>"},
    {"key": "reminder.perf_cycle_due", "module": "Reminders", "name": "Annual Performance Cycle Due",
     "subject": "Annual performance review cycle due — {{cycle_year}}",
     "merge_tags": ["cycle_year","platform_link"],
     "body": "<p>It's time to open the <strong>{{cycle_year}}</strong> performance review cycle.</p><p><a href=\"{{platform_link}}\">Open Performance module</a></p>"},
    {"key": "reminder.survey_cycle_due", "module": "Reminders", "name": "Annual Alignment Survey Due",
     "subject": "Annual Alignment Survey due — {{cycle_year}}",
     "merge_tags": ["cycle_year","platform_link"],
     "body": "<p>It's time to open the <strong>{{cycle_year}}</strong> Alignment Survey cycle.</p><p><a href=\"{{platform_link}}\">Open Surveys module</a></p>"},
]
