...
DEFAULT_TEMPLATES = [
    ...
    {"key": "onboarding.welcome", "module": "Onboarding", "name": "Welcome Email",
     "subject": "Welcome to Solvit — your login details", "merge_tags": ["employee_name","temp_password","login_url"],
     "body": "<p>Hi {{employee_name}},</p><p>Welcome to Solvit! Your account is ready.</p><p>Login: <a href=\"{{login_url}}\">{{login_url}}</a></p><p>Temporary password: <strong>{{temp_password}}</strong></p><p>Please change your password on first login.</p><p>— Solvit People Platform</p>"},
    ...
    {"key": "solver.activation", "module": "Solvers", "name": "Solver Account Activation",
     "subject": "Your Solver account is live", "merge_tags": ["solver_name","app_link","login_code"],
     "body": "<p>Hi {{solver_name}},</p><p>Your Solver account is now active. Download the app: {{app_link}}.</p><p>Login code: <strong>{{login_code}}</strong></p>"},
    {"key": "solver.tier_upgrade", "module": "Solvers", "name": "Solver Performance Tier Upgrade",
     "subject": "You've been upgraded to {{new_tier}}", "merge_tags": ["solver_name","new_tier","old_tier"],
     "body": "<p>Hi {{solver_name}},</p><p>Great work! You've been upgraded from {{old_tier}} to <strong>{{new_tier}}</strong>.</p>"},
    {"key": "solver.tier_downgrade", "module": "Solvers", "name": "Solver Performance Tier Downgrade",
     "subject": "Your performance tier has changed", "merge_tags": ["solver_name","new_tier","old_tier"],
     "body": "<p>Hi {{solver_name}},</p><p>Your tier has changed from {{old_tier}} to {{new_tier}}. Let's chat about how to bounce back.</p>"},
    {"key": "solver.suspension", "module": "Solvers", "name": "Solver Account Suspension Notice",
     ...
     "body": "<p>Hi {{solver_name}},</p><p>Your account has been suspended. Reason: {{reason}}.</p>"},
    {"key": "solver.reactivation", "module": "Solvers", "name": "Solver Account Reactivation",
     ...
     "body": "<p>Hi {{solver_name}},</p><p>Welcome back — your account has been reactivated.</p>"},
    ...
    {"key": "performance.review_complete", "module": "Performance", "name": "Performance Review Completed",
     "subject": "Your {{cycle_label}} review is ready", "merge_tags": ["employee_name","cycle_label","overall_score"],
     "body": "<p>Hi {{employee_name}},</p><p>Your {{cycle_label}} review is complete. Overall score: {{overall_score}}.</p>"},
    {"key": "performance.pip_initiated", "module": "Performance", "name": "PIP Initiated",
     "subject": "Performance Improvement Plan — next steps", "merge_tags": ["employee_name","effective_date","duration_weeks"],
     "body": "<p>Hi {{employee_name}},</p><p>A Performance Improvement Plan has been initiated effective {{effective_date}} for {{duration_weeks}} weeks.</p>"},
    ...
    {"key": "performance.pip_escalate", "module": "Performance", "name": "PIP Outcome — Escalation to Disciplinary",
     "subject": "PIP outcome — escalation notice", "merge_tags": ["employee_name","next_steps"],
     "body": "<p>Hi {{employee_name}},</p><p>Your PIP has been escalated. Next steps: {{next_steps}}.</p>"},
    ...
    {"key": "retention.stay_interview_invite", "module": "Retention", "name": "Stay Interview Invitation",
     "subject": "Stay interview invitation", "merge_tags": ["employee_name","manager_name","meeting_date"],
     "body": "<p>Hi {{employee_name}},</p><p>You're invited to a stay interview with {{manager_name}} on {{meeting_date}}.</p>"},
    ...
    {"key": "lnd.project_completed", "module": "L&D", "name": "Project Completion & Reward",
     "subject": "Project completed — reward processed", "merge_tags": ["employee_name","project_name","reward_kes"],
     "body": "<p>Hi {{employee_name}},</p><p>Congratulations on completing <strong>{{project_name}}</strong>. Reward of KES {{reward_kes}} has been processed.</p>"},
    ...
    {"key": "disciplinary.hearing", "module": "Disciplinary", "name": "Disciplinary Hearing Invitation",
     "subject": "Disciplinary hearing invitation", "merge_tags": ["employee_name","hearing_date","case_summary"],
     "body": "<p>Dear {{employee_name}},</p><p>You're invited to a disciplinary hearing on {{hearing_date}}. Case: {{case_summary}}.</p>"},
    {"key": "disciplinary.written", "module": "Disciplinary", "name": "Written Warning Issued",
     "subject": "Written warning", "merge_tags": ["employee_name","summary","valid_until"],
     "body": "<p>Dear {{employee_name}},</p><p>A written warning has been issued. Summary: {{summary}}. Valid until {{valid_until}}.</p>"},
    {"key": "disciplinary.final", "module": "Disciplinary", "name": "Final Written Warning",
     "subject": "Final written warning", "merge_tags": ["employee_name","summary","valid_until"],
     "body": "<p>Dear {{employee_name}},</p><p>A FINAL written warning has been issued. Summary: {{summary}}. Valid until {{valid_until}}.</p>"},
    {"key": "disciplinary.dismissal", "module": "Disciplinary", "name": "Dismissal Notification",
     "subject": "Notice of dismissal", "merge_tags": ["employee_name","effective_date","case_summary"],
     "body": "<p>Dear {{employee_name}},</p><p>Your employment is terminated effective {{effective_date}}. Case: {{case_summary}}.</p>"},

    # ---------------- Policies ----------------
    {"key": "policy.published", "module": "Policies", "name": "New Policy Published",
     "subject": "New policy: {{policy_name}}", "merge_tags": ["policy_name","summary","link"],
     "body": "<p>A new policy has been published: <strong>{{policy_name}}</strong>.</p><p>{{summary}}</p><p><a href=\"{{link}}\">View policy</a></p>"},
